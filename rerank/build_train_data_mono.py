...
# 文件路径
pairs_file = r'json_dataset/train_pairs.json'  # post_id 和 fact_check_id 的映射关系
post_file = r'translation\pol\json\post_train_tha-pol.json'    # post.json 文件路径
fact_check_file = r'translation\pol\json\fact_train_tha-pol.json'  # fact_check.json 文件路径
output_file = r'rerank_train_tha-pol.json'  # 输出的新文件
...
for post in posts:
    ...
    query = ' '.join([post_fields.get('ocr_text', ''),
                      post_fields.get('ocr_translation', ''),
                      post_fields.get('text_original', ''),
